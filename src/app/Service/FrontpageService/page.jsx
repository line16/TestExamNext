...
const FrontpageService = () => {
  ...
  return (
    <>
      ...
      <section className="text-center p-5 w-9/12">
        <h3 className="font-semibold text-3xl p-2">Popular Procedures</h3>
        <p>
          In the tradition of the deep cleansing, exfoliating and skin
          conditioning Leo Spa treatments originating in Morocco and Turkey, our
          SPA collection offers a luxurious, ultimately relaxing, truly holistic
          wellness experience.
        </p>
      </section>

      <section className="flex flex-row justify-center items-center w-full flex-wrap pb-5">
        {data &&
          data.slice(0, 3).map((p) => (
            ...
            >
              ...
              ></p>
              <button className="bg-gray-800 text-white rounded-full my-6 px-4 py-2 hover:bg-rose-400">
